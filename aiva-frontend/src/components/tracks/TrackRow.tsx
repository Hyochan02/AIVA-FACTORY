...
import { formatPlays, formatDuration, gradColor, trackTitle } from '../../utils/format'
  ...
  >
    ...
    <div className="flex-1 min-w-0">
      <div className="flex items-center gap-2">
        <span className="text-sm font-semibold text-white truncate">{trackTitle(track.title, track.version_num)}</span>
